...
class RegistrationFormType extends AbstractType implements ContainerAwareInterface {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options){
        ...
        //Meta del Objetivo
        $builder->add('goal','percent',array('label' => 'form.goalObjetiveStrategic','label_attr' => array('class' => 'label'), 'translation_domain' => 'PequivenObjetiveBundle','attr' => array('class' => 'input validate[required]','size' => 8)));
        ...
        //Tipo de Evaluación
            ...
            $builder->addEventSubscriber(new AddIndicatorStrategicFieldListener($this->container,array('typeStrategic' => true)));
    }
