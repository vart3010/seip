...
class RegistrationFormType extends AbstractType implements ContainerAwareInterface {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options){
        ...
        //Meta del Objetivo
        $builder->add('goal','percent',array('label' => 'form.goal','label_attr' => array('class' => 'label'), 'translation_domain' => 'PequivenObjetiveBundle','attr' => array('placeholder' => "100",'class' => 'input', 'size' => 8)));
