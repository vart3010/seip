...
use Pequiven\MasterBundle\Model\Cargo as modelCargo;

/**
 * Cargo
 *
 * @ORM\Table(name="seip_c_cargo")
 * @ORM\Entity(repositoryClass="Pequiven\MasterBundle\Repository\CargoRepository")
 */
class Cargo extends modelCargo
{
    /**
     * @var integer
     *
