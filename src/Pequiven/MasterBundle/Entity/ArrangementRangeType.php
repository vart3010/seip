...
use Pequiven\MasterBundle\Model\ArrangementRangeType as modelArrangementRangeType;

/**
 * ArrangementRangeType
 *
 * @ORM\Table(name="seip_c_arrangement_range_type")
 * @ORM\Entity(repositoryClass="Pequiven\MasterBundle\Repository\ArrangementRangeTypeRepository")
 * @author matias
 */
class ArrangementRangeType extends modelArrangementRangeType {
