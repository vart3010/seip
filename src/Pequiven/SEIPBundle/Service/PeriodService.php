...
//        }
    ...
    function isAllowLoadArrangementProgram() {
        ...
        if ($period->getName() == '2016' && ($this->getUser()->getId() == 104 || $this->getUser()->getId() == 103 || $this->getUser()->getId() == 295 || $this->getUser()->getId() == 4642 || $this->getUser()->getId() == 110 || $this->getUser()->getId() == 63 || $this->getUser()->getId() == 1029 || $this->getUser()->getId() == 1047)) {
            $result = true;
        }
