...
//        }
    ...
    function isAllowLoadArrangementProgram() {
        ...
        if ($period->getName() == '2016' && ($this->getUser()->getId() == 121 || $this->getUser()->getId() == 293)) {
            $result = true;
        }
...
//        var_dump($period->getName());die();
    ...
    function isAllowPlanningReport() {
        ...
        $user = $this->getUser();
        if ($period->getName() == '2016' && ($user->getId() == 330 || $user->getId() == 5816 || $user->getId() == 104 || $user->getId() == 1798 || $user->getId() == 1668)) {
            $result = true;
        }
