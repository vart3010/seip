...
class LinkGeneratorService extends LinkGenerator
{
    ...
    static function getConfigObjects()
    {
        return array(
            ...
            array('class' => 'Pequiven\SEIPBundle\Entity\DataLoad\Production\ProductPlanning','icon' => 'fa fa-tags','route' => 'pequiven_product_planning_show',"translation_domain" => "PequivenSEIPBundle"),
        );
    }
