...
class DetailConsumerPlanningServiceFactorType extends AbstractType
{
        /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Pequiven\SEIPBundle\Entity\DataLoad\ServiceFactor\DetailConsumerPlanningServiceFactor',
    ...
    {
        return 'pequiven_seipbundle_dataload_servicefactor_detailconsumerplanningservicefactor';
    }
}
