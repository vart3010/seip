...
class DetailConsumerPlanningGasFlowType extends AbstractType
{
        /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Pequiven\SEIPBundle\Entity\DataLoad\GasFlow\DetailConsumerPlanningGasFlow',
    ...
    {
        return 'pequiven_seipbundle_dataload_gasflow_detailconsumerplanninggasflow';
    }
}
