 ...
 */
class ReportTemplateDeliveryType extends AbstractType {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Pequiven\SEIPBundle\Entity\Delivery\ReportTemplateDelivery',
    ...
    public function getName() {
        return 'pequiven_seipbundle_dataload_reporttemplatedelivery';
    }
