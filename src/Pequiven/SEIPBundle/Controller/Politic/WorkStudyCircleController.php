...
class WorkStudyCircleController extends SEIPController {
    ...
    {        
        ...
        /*foreach ($workStudyCircle as $value) {
          
            $var = $value->getComplejo()->getId();
            var_dump($var);

        }*/

        //$repository = $em->getRepository('\Pequiven\SEIPBundle\Repository\UserRepository')->findQueryUsersAll();
        //$users = $this->get('pequiven_seip.repository.user')->findAll();
