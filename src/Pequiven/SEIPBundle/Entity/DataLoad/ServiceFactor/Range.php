 ...
 * @ORM\Table(name="seip_report_plant_service_factor_range")
 * @ORM\Entity()
 */
class Range extends BaseModel
{
     ...
     * @ORM\ManyToOne(targetEntity="Pequiven\SEIPBundle\Entity\DataLoad\ServiceFactor\DetailConsumerPlanningServiceFactor",inversedBy="ranges")
   ...
   /**
    ...
    /**
     * Set detailConsumerPlanningServiceFactor
     *
     ...
     * @return Range
     */
    public function setDetailConsumerPlanningServiceFactor(\Pequiven\SEIPBundle\Entity\DataLoad\ServiceFactor\DetailConsumerPlanningServiceFactor $detailConsumerPlanningServiceFactor)
    {
        $this->detailConsumerPlanningServiceFactor = $detailConsumerPlanningServiceFactor;
