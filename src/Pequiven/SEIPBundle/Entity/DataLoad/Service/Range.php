 ...
 * @ORM\Table(name="seip_report_plant_service_range")
 * @ORM\Entity()
 */
class Range extends BaseModel
{
     ...
     * @ORM\ManyToOne(targetEntity="Pequiven\SEIPBundle\Entity\DataLoad\Service\DetailConsumerPlanningService",inversedBy="ranges")
     * @ORM\JoinColumn(nullable=false)
     */
    private $detailConsumerPlanningService;
