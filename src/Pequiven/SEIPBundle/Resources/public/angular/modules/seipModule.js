...
//            });
        ...
        .controller('ChartsDashboardController', function ($scope, $http) {
            ...
            $scope.chargeChartBarsArea = function (indicatorId) {
                var chargeChartBarsArea = Routing.generate("getDataChartBarsArea", {id: indicatorId});
                $scope.chargeChartBarsArea = {};
                $http.get(chargeChartBarsArea).success(function (data) {
                    $scope.chargeChartBarsArea = {
                        "chart": data.dataSource.chart,
                        "categories": data.dataSource.categories.category,
                        "dataset": data.dataSource.dataset
                    }
