 ...
 */
namespace Pequiven\SEIPBundle\Model\Sip\PDF;

use Symfony\Component\DependencyInjection\ContainerAwareInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;
use TCPDF;

class UbchPdf extends TCPDF implements ContainerAwareInterface{
    /**
    ...
    public function Header() {
        // Logo SEIP
        $image_file = $this->generateAsset('bundles/pequivenseip/logotipos-pqv/banner-ubch.png'); //K_PATH_IMAGES.'logo_example.jpg';
        $this->Image($image_file, 7, 5, 280, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        // Set font
        $this->SetFont('helvetica', 'B', 16);
        $this->SetTextColor(255,0,0);
        // Title
        $text='<div align="center" style="font-size: 1em;color: #000000;">'.$this->title.'<br>'./*$this->period->getDescription().*/'</div>';
        $this->writeHTML($text);                
    }
