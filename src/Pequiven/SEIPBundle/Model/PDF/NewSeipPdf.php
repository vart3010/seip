...
class NewSeipPdf extends TCPDF implements ContainerAwareInterface{
    ...
    public function Header() {
        ...
        // Logo SEIP
        $image_file = $this->generateAsset('bundles/pequivenseip/logotipos-pqv/Logo_Pequiven.jpg'); //K_PATH_IMAGES.'logo_example.jpg';
        $this->Image($image_file, 10, 10, 50, 30, 'jpg', '', 'T', false, 300, '', false, false, 0, false, false, false);
        // Set font
        ...
        $this->writeHTML($text);
        // Logo Pqv
        $image_file = $this->generateAsset('bundles/pequivenseip/logotipos-pqv/Logo_Seip.jpg'); //K_PATH_IMAGES.'logo_example.jpg';
        $this->Image($image_file, 190, 10, 15, 15, 'jpg', '', 'T', false, 300, '', false, false, 0, false, false, false);
        // Línea HR
