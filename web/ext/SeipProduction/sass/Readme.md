...
folder are mapped to the application's root namespace, 'SeipProduction'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SeipProduction"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SeipProduction' in the same way
as `"SeipProduction/sass/src"`.
