...
-- FINANZAS
UPDATE seip_monitor SET objTacticOriginal = 4, indTacticOriginal = 0, objOperativeOriginal = 57, indOperativeOriginal = 56, arrangementProgramTactic = 0, arrangementProgramOperative = 11 WHERE fk_gerencia = 22;
-- P.C.P.
...
-- RECURSOS HUMANOS
UPDATE seip_monitor SET objTacticOriginal = 7, indTacticOriginal = 7, objOperativeOriginal = 80, indOperativeOriginal = 42, arrangementProgramTactic = 0, arrangementProgramOperative = 14 WHERE fk_gerencia = 18;
-- SALUD
