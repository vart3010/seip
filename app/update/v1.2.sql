...
CREATE TABLE seip_gerencia_configuration (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, arrangementProgramUserToApproveTactical_id INT NOT NULL, arrangementProgramUserToApproveOperative_id INT NOT NULL, INDEX IDX_BB6B2A9E7FEE9C13 (arrangementProgramUserToApproveTactical_id), INDEX IDX_BB6B2A9ECDABF5AB (arrangementProgramUserToApproveOperative_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
...
CREATE TABLE ArrangementProgramDetails (id INT AUTO_INCREMENT NOT NULL, revisionDate DATETIME DEFAULT NULL, approvalDate DATETIME DEFAULT NULL, reviewedBy_id INT DEFAULT NULL, approvedBy_id INT DEFAULT NULL, INDEX IDX_165E90D79C6A92E (reviewedBy_id), INDEX IDX_165E90D7FACFC38A (approvedBy_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
ALTER TABLE Historical ADD CONSTRAINT FK_EA32CED3A76ED395 FOREIGN KEY (user_id) REFERENCES seip_user (id);
ALTER TABLE seip_gerencia_configuration ADD CONSTRAINT FK_BB6B2A9E7FEE9C13 FOREIGN KEY (arrangementProgramUserToApproveTactical_id) REFERENCES seip_user (id);
ALTER TABLE seip_gerencia_configuration ADD CONSTRAINT FK_BB6B2A9ECDABF5AB FOREIGN KEY (arrangementProgramUserToApproveOperative_id) REFERENCES seip_user (id);
